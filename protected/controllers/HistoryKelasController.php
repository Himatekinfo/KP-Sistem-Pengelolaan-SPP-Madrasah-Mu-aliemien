...
class HistoryKelasController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['HistoryKelas'])) {
            $model->attributes = $_POST['HistoryKelas'];
            if ($model->save())
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('HistoryKelas');
    ...
    public function actionAdmin() {
        $model = new HistoryKelas('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['HistoryKelas']))
            $model->attributes = $_GET['HistoryKelas'];
    ...
    public function loadModel($id) {
        $model = HistoryKelas::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'history-kelas-form') {
