...
require_once(dirname(__FILE__).'/fpd/fpdi2tcpdf_bridge.php');
require_once(dirname(__FILE__).'/fpd/fpdi.php');
...
class ETcPdf
{
    ...
    */
	...
	public static function getPageNumbers($input)
	{
		$pdf = new FPDI('L','cm','A4');
		$pc = $pdf->setSourceFile($input);
		return $pc;
	}
	
	public static function ExtractPagesTo($input, $outFile, $start, $end)
	{
